...
urlpatterns = [
    ...
    path('friend/requests/sent/', views.FriendRequestsSentAPI.as_view(), name='friend_requests_sent'),
    path('friend/requests/received/', views.FriendRequestsReceivedAPI.as_view(), name='friend_requests_received'),
]
